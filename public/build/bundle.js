...
var app = (function () {
    ...
    const file = "src/library/Library.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 23, 2, 382);
    			attr_dev(h1, "class", "svelte-421zze");
    			add_location(h1, file, 24, 2, 429);
    			attr_dev(header, "class", "svelte-421zze");
    			add_location(header, file, 22, 0, 371);
    			attr_dev(p, "class", "greeting svelte-421zze");
    			add_location(p, file, 27, 0, 457);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 4, 0, 69);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
